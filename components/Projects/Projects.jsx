  ...
  return (
    <section id='projects' className='bg-lightBlue/30'>
      <div className='container mx-auto px-12 lg:px-48 pt-32 pb-52'>
        <p className='heading font-baskerville text-5xl text-black text-center mx-auto'>Projects</p>
                ...
                <Card
                  ...
                  pSkills={
                    project.skills.map((skill) => {
                      return (
                        <div className='bg-white/50 text-black font-nunito font-bold px-2 py-1 mt-3 rounded-xl'>
                          {skill}
                        </div>
                      )
                    })
